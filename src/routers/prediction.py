...
def posture_points(data: BackViewDataToPredict | SideViewDataToPredict, lang: Lang = Lang.en.value) -> BackViewPrediction | SideViewPrediction:
    ...
    message = generate_message(res, 'en')
